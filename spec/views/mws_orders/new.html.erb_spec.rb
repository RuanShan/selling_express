...
RSpec.describe "mws_orders/new", type: :view do
  before(:each) do
    assign(:mws_order, MwsOrder.new(
  ...
  it "renders new mws_order form" do
    render

    assert_select "form[action=?][method=?]", mws_orders_path, "post" do
