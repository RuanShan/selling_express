...
RSpec.describe "mws_order_items/new", type: :view do
  before(:each) do
    assign(:mws_order_item, MwsOrderItem.new(
      :asin => "MyString",
  ...
  it "renders new mws_order_item form" do
    render

    assert_select "form[action=?][method=?]", mws_order_items_path, "post" do
